...
import ordersAll, { actions as ordersAllActions } from './features/orders.all/slice.ts';
import ordersProfile, { actions as ordersProfileActions } from './features/orders.profile/slice.ts';
